...
//RTOS -- Assignment 10
//3-15-22
//This program uses the HDC1080 temperature / humidity sensor, 
//the 28BYJ-48 Step Motor, Pico and Vandaluino3 board to emit
//temperatures, humidity levels, motor status, motor operation
//and RGBW LED lights. 
...
//Task Prototypes
void readHDC1080Task(void *pvParameters);
void stepMotorTask(void *pvParameters);
void buttonsTask(void *pvParameters);
void segLEDLeft(void *pvParameters);
void segLEDRight(void *pvParameters);
...
int main() {
  ...
  while (!tud_cdc_connected()) { sleep_ms(100);  }    
    ...
    ledColorQueue = xQueueCreate(2, sizeof(int));
    ...
    xTaskCreate(ledControlTask, "ledControlTask", 256, NULL, 2, NULL);

    //xTaskCreate(ledStripTask, "ledStripTask", 256, NULL, 2, NULL);
...
//task to control leds on-board
void ledControlTask(void *pvParameters){
     WS2812 ledStrip(
        LED_PIN,            // Data line is connected to pin 20. (GP0)
        LED_Length,         // Strip is 4 LEDs long.
        ...
        WS2812::FORMAT_WRGB // Pixel format used by the LED strip
    );
    ...
    while(true){
        ...
        if(xQueueReceive(ledColorQueue, &led_colors, 0) == pdPASS){};

        //all green
        if(led_colors == 0){
            ledStrip.fill( WS2812::RGB(255, 0, 0), 0, LED_Length/4);
            ledStrip.fill( WS2812::RGB(255, 0, 0), 1, LED_Length/4);
            ledStrip.fill( WS2812::RGB(255, 0, 0), 2, LED_Length/4);
            ledStrip.fill( WS2812::RGB(255, 0, 0), 3, LED_Length/4);
            ledStrip.show();
            vTaskDelay(10/portTICK_PERIOD_MS);
        }
        //all blue
        else if(led_colors == 1){
            ledStrip.fill( WS2812::RGB(0, 0, 255), 0, LED_Length/4);
            ledStrip.fill( WS2812::RGB(0, 0, 255), 1, LED_Length/4);
            ledStrip.fill( WS2812::RGB(0, 0, 255), 2, LED_Length/4);
            ledStrip.fill( WS2812::RGB(0, 0, 255), 3, LED_Length/4);
            ledStrip.show();
            vTaskDelay(10/portTICK_PERIOD_MS);
        }
        //cool strobe!
        else if(led_colors == 2){
            ledStrip.fill( WS2812::RGB(255, 0, 0), 0, LED_Length/4);
            ledStrip.fill( WS2812::RGB(0, 255, 0), 1, LED_Length/4);
            ledStrip.fill( WS2812::RGB(0, 0, 255), 2, LED_Length/4);
            ledStrip.fill( WS2812::RGB(0, 255, 255), 3, LED_Length/4);
            ledStrip.show();
            vTaskDelay(100/portTICK_PERIOD_MS);

            ledStrip.fill( WS2812::RGB(255, 0, 0), 1, LED_Length/4);
            ledStrip.fill( WS2812::RGB(0, 255, 0), 2, LED_Length/4);
            ledStrip.fill( WS2812::RGB(0, 0, 255), 3, LED_Length/4);
            ledStrip.fill( WS2812::RGB(0, 255, 255), 0, LED_Length/4);
            ledStrip.show();
            vTaskDelay(100/portTICK_PERIOD_MS);

            ledStrip.fill( WS2812::RGB(255, 0, 0), 2, LED_Length/4);
            ledStrip.fill( WS2812::RGB(0, 255, 0), 3, LED_Length/4);
            ledStrip.fill( WS2812::RGB(0, 0, 255), 0, LED_Length/4);
            ledStrip.fill( WS2812::RGB(0, 255, 255), 1, LED_Length/4);
            ledStrip.show();
            vTaskDelay(100/portTICK_PERIOD_MS);

            ledStrip.fill( WS2812::RGB(255, 0, 0), 3, LED_Length/4);
            ledStrip.fill( WS2812::RGB(0, 255, 0), 0, LED_Length/4);
            ledStrip.fill( WS2812::RGB(0, 0, 255), 1, LED_Length/4);
            ledStrip.fill( WS2812::RGB(0, 255, 255), 2, LED_Length/4);
            ledStrip.show();
            vTaskDelay(100/portTICK_PERIOD_MS);            

        }
        //all red
        else if(led_colors == 3){
            ledStrip.fill( WS2812::RGB(0, 255, 0), 0, LED_Length/4);
            ledStrip.fill( WS2812::RGB(0, 255, 0), 1, LED_Length/4);
            ledStrip.fill( WS2812::RGB(0, 255, 0), 2, LED_Length/4);
            ledStrip.fill( WS2812::RGB(0, 255, 0), 3, LED_Length/4);
        ...
        //all yellow
        else if(led_colors == 4){
            ledStrip.fill( WS2812::RGB(255, 255, 0), 0, LED_Length/4);
            ledStrip.fill( WS2812::RGB(255, 255, 0), 1, LED_Length/4);
            ledStrip.fill( WS2812::RGB(255, 255, 0), 2, LED_Length/4);
            ledStrip.fill( WS2812::RGB(255, 255, 0), 3, LED_Length/4);
            ledStrip.show();
            vTaskDelay(10/portTICK_PERIOD_MS);
        }

        //lighter blue
        else if(led_colors == 5){
            ledStrip.fill( WS2812::RGB(255, 0, 255), 0, LED_Length/4);
            ledStrip.fill( WS2812::RGB(255, 0, 255), 1, LED_Length/4);
            ledStrip.fill( WS2812::RGB(255, 0, 255), 2, LED_Length/4);
            ledStrip.fill( WS2812::RGB(255, 0, 255), 3, LED_Length/4);
            ledStrip.show();
            vTaskDelay(10/portTICK_PERIOD_MS);
        }
